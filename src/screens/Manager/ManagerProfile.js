...
export default function ManagerProfile({ navigation, setIsLoggedIn }) {   // <-- RECEIVING HERE
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.value}>alex.johnson@example.com</Text>

        <Text style={styles.label}>Employee ID</Text>
        <Text style={styles.value}>EMP-4521</Text>

        <Text style={styles.label}>Phone</Text>
        <Text style={styles.value}>+91 98765 12345</Text>
      </View>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.value}>Noida Sector 62</Text>

        <Text style={styles.label}>Reports To</Text>
        <Text style={styles.value}>Regional Director – North Zone</Text>
      </View>
      ...
      <View style={styles.card}>
        ...
        <TouchableOpacity style={styles.actionButton}>
          ...
          <Text style={styles.actionText}>Security & Permissions</Text>
        </TouchableOpacity>
      </View>
      ...
      <TouchableOpacity
        ...
        onPress={() => setIsLoggedIn(false)}            // <-- LOGOUT FIX
      >
...
const styles = StyleSheet.create({
  ...
  logoutText: { color: "#fff", fontSize: 16, marginLeft: 6, fontWeight: "600" },
});
